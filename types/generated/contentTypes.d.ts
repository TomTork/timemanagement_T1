...
export interface ApiTokenToken extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    worktimes: Schema.Attribute.Relation<'oneToMany', 'api::worktime.worktime'>;
  };
}
...
export interface ApiWorktimeWorktime extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    finish: Schema.Attribute.Media<'images' | 'files', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::worktime.worktime'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::worktime.worktime': ApiWorktimeWorktime;
